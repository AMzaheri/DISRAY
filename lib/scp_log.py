...
f=open(env.DISRAY_id_path)
n_count=f.read()
f.close()
child = ssh_command ( line.split()[2], '  /home/%s/DISRAY/log/log %s@%s:/home/%s/DISRAY/log/log%s'%(os.getenv("USER"),line.split()[1],line.split()[0],line.split()[1] ,n_count))
